...
Util.Objects["validdevice"] = new function() {
	this.init = function(body) {
		...
		if(!warning_displayed) {
			...
			warning.innerHTML = "<h1>Warning</h1><p>This site is designed for touch interaction on a smartphone - using a pointer such as a mouse or trackpad might have unitented side effects. Move the mouse slowly when dragging to minimize errors.</p><p>Click to continue.</p>"
			u.e.click(warning);
